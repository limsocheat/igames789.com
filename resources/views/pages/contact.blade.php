                ...
                <div class="col-sm-12 col-md-3">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="http://www.igames789.com" class="text-warning"><i class="fab fa-skype text-primary "
                                    style="font-size: 1.33333em;"></i>+84 033 946
                                6132</a></li>
                        <li><a href="http://www.igames789.com" class="text-warning"><i class="fab fa-telegram text-primary"
                                    style="font-size: 1.33333em;"></i>
                                +84 033 946 6132</a></li>
